...
public class ClienteDAO {
    ...
    Conexion cn = new Conexion();//LA CONECCION EN SI, PARA IR DIRECTO A LA BASE DE DATOS;
    Connection con;// TIPO DE DATO PARA REALIZAR EFECTIVAMENTE LA CONECCION.
    ...
    public boolean registrarCliente(Cliente cl){
        ...
        try {
            ...
            ps.execute();
            //execute() te permite hacer sentencias de recuperacion o de Modificacion.
            return true;
